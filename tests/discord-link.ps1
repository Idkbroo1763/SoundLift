...
if (-not $source.Contains("`$script:appVersion = '1.6.4'")) { throw 'Application version was not updated to 1.6.4' }
...
foreach ($requiredThemeMarker in @('#C084FC','#22D3EE','#FB923C','#FACC55','OLED fekete')) {
